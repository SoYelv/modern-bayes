...
and $$y=\sqrt{2}x^{2} \implies  x^4 = y^2/2.$$

In addition, 

$$y=\sqrt{2}x^{2} \implies 
dy = \sqrt{2} \times 2x dx \implies 
dy = \sqrt{2} \times 2 y^{1/2} \times 2^{-1/4} dx \implies dy = 2^{5/4} \times y^{1/2} dx \implies dx = 2^{-5/4} \times y^{-1/2} dy.$$

This implies that

\begin{align*}
I &= \int_{-\infty}^{\infty}\exp(-x^{4})\,dx \\ &= 2\int_{0}^{\infty}\exp(-x^{4})\,dx \\
&=2 \cdot 2^{-5/4} \int_{0}^{\infty}\frac{\exp(-y^{2}/2)}{\sqrt{y}}\,dy \\
...
which represents the expectation of $20\exp(-x^4)$ over the uniform distribution on $[-10,10]$.  
