...
We set $a  = 0.05, 1, 0.05$ and $b = 1, 1, 10$.
...
Takeaway: one estimator might work better for some $\theta$ values whereas another estimator might work better for other $\theta$ values. Thus, all three estimators are admissible (no estimator is every strictly better than another estimator). 
