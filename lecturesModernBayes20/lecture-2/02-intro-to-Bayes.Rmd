...
- The posterior risk from carrying the umbrella is $1-p = 0.8.$ 
- The posterior risk from NOT carrying the umbrella is $10p = 2.$ 

In this situation, that statistician assumes less Bayes risk of getting wet by carrying his umbrella around.


See written details here: \url{https://github.com/resteorts/modern-bayes/blob/master/reading/babybayes-master.pdf} pages 99--100, which cover this material more in depth and cover more examples. 

Exercise (continued)
===

What is value of $p$ that results in the two situations having equal Bayes risk? (Complete this on your own). 
...
posterior_risk <- function(c, s = 30000) {
  ...
  # apply(vector, margin = 1, function, additional arguments to function)
...
===
```{r}
# Plot posterior risk against c and saves to pdf.
